...
attribute @s generic.max_health modifier add 8770068e-63c1-41c0-83b4-ab6bc858093d "up_2_vie" 5 add_value
attribute @s generic.attack_damage modifier add 9d9757da-8ccd-43fb-9a64-2b71a9af196e "up_2_dmg" 2 add_value
