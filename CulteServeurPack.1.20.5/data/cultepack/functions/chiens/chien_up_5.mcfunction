...
attribute @s generic.max_health modifier add a25468b9-99ba-468b-977e-12942dabe98a "up_2_vie" 10 add_value
attribute @s generic.attack_damage modifier add 37c75040-c920-4f56-a966-a5dc878eea63 "up_2_dmg" 2 add_value
