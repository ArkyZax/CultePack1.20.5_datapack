...
attribute @s generic.max_health modifier add 6d86691c-a291-426d-84d2-1bfe97cd4336 "up_1_vie" 5 add_value
attribute @s generic.attack_damage modifier add 68907768-b7d9-45b1-bda0-afb8793c008e "up_1_dmg" 2 add_value
