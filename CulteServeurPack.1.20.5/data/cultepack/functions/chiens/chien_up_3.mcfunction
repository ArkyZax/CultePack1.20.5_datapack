...
attribute @s generic.max_health modifier add 73a46a81-ee02-4f92-9dbb-5e10baa33d48 "up_2_vie" 5 add_value
attribute @s generic.attack_damage modifier add a5a2a3f4-3473-4e6b-b312-7a32a69d271d "up_2_dmg" 2 add_value
